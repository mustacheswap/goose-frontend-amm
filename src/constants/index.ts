...
export const MUSTACHE = new Token(ChainId.MAINNET, 'XXX', 18, 'MUSTACHE', 'Mustache Token') // Mustache contract address
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], DAI, BUSD, USDT, EOS, DOT, MUSTACHE, USDC]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], DAI, BUSD, USDT, MUSTACHE, USDC]
}
